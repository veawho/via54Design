...
[![GitHub stars](https://img.shields.io/github/stars/veawho/via54Design)](https://github.com/veawho/via54Design/stargazers)
[![GitHub issues](https://img.shields.io/github/issues/veawho/via54Design)](https://github.com/veawho/via54Design/issues)
...
```bibtex
@software{via54_design,
  author = {veawho (巫师叔叔)},
  title  = {via54Design},
  year   = {2026},
  url    = {https://github.com/veawho/via54Design}
}
```
...
- Issues: [GitHub Issues](https://github.com/veawho/via54Design/issues)
