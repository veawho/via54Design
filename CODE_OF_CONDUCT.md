...
This Code of Conduct applies within all community spaces — both online (GitHub
issues, discussions, PRs, comments) and offline (events, conferences, meetups)
...
- 📧 **security@via54design.local** (security@via54design.local)
- 📨 **DM on GitHub** to @veawho
