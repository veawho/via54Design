...
5. **v0.7.1 时长归一化**: en 28.925s → 30.000s (apad 旁白补静音 + atrim 配乐 + -t 30 视频)

## 🐛 v0.7.1 修复

- **en.mp4 时长偏差** (28.925s vs 30.000s): 末段 1.075s 缺音频
- **修法**: `gen_video.py` mux 步骤加 `apad` 旁白补静音 + `atrim=0:30.0` 配乐 + `-t 30` 视频流
- **结果**: 3 语全部 30.000s 完美对齐 (zh 30.00/9.4MB, en 30.00/9.1MB, ja 30.00/9.3MB)
